...
class AddVendorPopup extends ConsumerWidget {
  const AddVendorPopup({super.key, this.vendor});

  final PktbsVendor? vendor;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    ref.watch(addVendorProvider(vendor));
    final notifier = ref.read(addVendorProvider(vendor).notifier);
    return AnimatedPopup(
      child: AlertDialog(
        title: Text(vendor == null ? 'Add Vendor' : 'Edit Vendor'),
        content: SizedBox(
          width: min(400, context.width),
          child: ref.watch(addVendorProvider(vendor)).when(
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  ...
                                  hintText:
                                      'Enter vendor\'s opening balance...',
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text(
              vendor == null ? 'Add Vendor' : 'Update Vendor',
