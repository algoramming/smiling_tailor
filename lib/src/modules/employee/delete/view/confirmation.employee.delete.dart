...
class ConfirmDeleteEmployeePopup extends StatefulWidget {
  ...
  @override
  State<ConfirmDeleteEmployeePopup> createState() =>
      _ConfirmDeleteEmployeePopupState();
}

class _ConfirmDeleteEmployeePopupState
    extends State<ConfirmDeleteEmployeePopup> {
  String? text;
  @override
