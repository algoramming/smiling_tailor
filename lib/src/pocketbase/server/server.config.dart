...
//       if (beamerGlobal != null) beamerGlobal!.update();
//     },
//     // httpClientFactory: () {
//     //   return Client()
//     //     ..head(Uri.parse("$baseUrl/api/realtime"), headers: {
...
//     if (beamerGlobal != null) beamerGlobal!.beamBack();
//     if (beamerGlobal != null) beamerGlobal!.update();
//   },
//       // cancelOnError: true,
